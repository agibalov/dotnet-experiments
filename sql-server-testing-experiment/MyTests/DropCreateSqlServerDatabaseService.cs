...
namespace MyTests
{
    public class DropCreateSqlServerDatabaseService
    {
        private readonly string _connectionString;

        public DropCreateSqlServerDatabaseService(string connectionString)
        {
            _connectionString = connectionString;
        }

        public void DropDatabaseIfExistsAndCreateANewOne()
        {
